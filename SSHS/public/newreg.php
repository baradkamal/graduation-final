...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $user_status = $_POST["user_status"];; // 1 for default status for new user is active

  // Execute statement and display success message
  if ($stmt->execute()) {
    echo "New record created successfully";
    echo "<div x-data='{show: true}' x-show='show' x-transition:leave.duration.400ms='' class='flex p-2 bg-blue-200 text-blue-800 p-4 text-sm rounded border border-blue-300 my-3'>
...
<body>
  ...
  <div class="h-screen">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="bg-white  md:px-24 px-4 pt-6 pb-8 mb-4">
            ...
            <div class=" p-10 flex items-center  justify-between">
              <div>
                ...
                <div class="text-gray-600 mb-8">
                  Thank you. Please click the link in the message to activate
                  your account.
                </div>

                <button @click="step = 1" class="w-40 block mx-auto focus:outline-none py-2 px-5 rounded-lg shadow-sm text-center text-gray-600 bg-white hover:bg-gray-100 font-medium border">Back
                  to home</button>
              </div>
            </div>
          </div>
            ...
            <div class="border-b-2 py-4">
              ...
              <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="flex-1">
                  ...
                  <div x-show="step === 3">
                    <div class="text-lg font-bold text-gray-700 leading-tight">Address Information</div>
                  </div>

                  <div x-show="step === 4">
                    <div class="text-lg font-bold text-gray-700 leading-tight">Account Information</div>
                  </div>
                </div>
            ...
            <div class="py-10">
              <div x-show.transition.in="step === 1">
                ...
                <div class="mb-5 text-center">
                  <div class="mx-auto w-24 h-24 mb-2 border rounded-full relative bg-gray-100 mb-4 shadow-inset">
                    <img id="image" class="object-cover w-full h-24 rounded-full" :src="image" />
                  </div>
                ...
                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="user_fname">First Name</label>
                  <input type="text" name="user_fname" id="user_fname" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your firstname..." required>
                </div>

                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="user_mname">middle name</label>
                  <input type="text" name="user_mname" id="user_mname" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your Middlename..." required>

                </div>

                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="user_lname">Last name</label>
                  <input type="text" name="user_lname" id="user_lname" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your Lastname..." required>
              ...
              <div x-show.transition.in="step === 2">
                <div class="h-96 max-h-full">
                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="user_mobile">Mobile No:</label>
                  <input type="tel" name="user_mobile" id="user_mobile" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your MobileNo..." required>
                </div>
                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="user_email">Email</label>
                  <input type="email" name="user_email" id="user_email" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your EmailId..." required>
                </div>
                </div>
              ...
              <div x-show.transition.in="step === 3">
                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="house_no">House Number</label>
                  <input type="number" name="house_no" id="house_no" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your HouseNo..." required>

                </div>
                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="user_address">Address</label>
                  <textarea name="user_address" id="user_address" placeholder="Enter your address..." class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" required></textarea>
                </div>

                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="alternate_address"> Alternate Address</label>
                  <textarea name="alternate_address" id="alternate_address" placeholder="Enter your Alternate address..." class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" required></textarea>
                </div>

                <div class="mb-5">
                  <label class="font-bold mb-1 text-gray-700 block" for="city_id"> City pin code</label>
                  <input id="city_id" type="text" name="city_id" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Enter your city pincode..." required>
              ...
              <div x-show.transition.in="step === 4">
                <div class="mb-5">
                  ...
                  <input type="text" name="username" id="username" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="enter your username..." required>
                </div>

                <div class="mb-5">
                  <label for="password" class="font-bold mb-1 text-gray-700 block">Set up password</label>
                  <div class="text-gray-600 mt-2 text-sm mb-4">
                    Please create a secure password including the following criteria below.

                    <ul class="list-disc text-xm ml-4 mt-2">
                  ...
                  <div class="relative">
                    <input :type="togglePassword ? 'text' : 'password'" @keydown="checkPasswordStrength()" id="password" name="password" x-model="password" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Your strong password..." required>
                ...
                <div class="mb-5" style="display:none;">
                  <div class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium md:w-1/3">
                    <label class="block font-medium mb-2" for="user_status">User Status</label>
                    <select id="user_status" name="user_status" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" required hidden>
                ...
                <div class="mb-5">
                  <div class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium md:w-1/3">
                    ...
                    <select id="user_type" name="user_type" class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" required>
        ...
        <div class="fixed bottom-0 left-0 right-0 py-5 bg-white shadow-md" x-show="step != 'complete'">
          <div class="max-w-3xl mx-auto px-4">
            <div class="flex justify-between">
              <div class="w-1/2">
                <button x-show="step > 1" @click="step--" type="button" class="w-32 focus:outline-none py-2 px-5 rounded-lg shadow-sm text-center text-purple-600 bg-white hover:bg-gray-100 font-medium border">Previous</button>
              </div>

              <div class="w-1/2 text-right">
                <button x-show="step < 4" @click="step++" type="button" class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-purple-500 hover:bg-purple-600 font-medium">Next</button>

                <button @click="step = 'complete'" x-show="step === 4" type="submit" class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-purple-500 hover:bg-purple-600 font-medium">Complete</button>
              </div>
            </div>
          </div>
        </div>
